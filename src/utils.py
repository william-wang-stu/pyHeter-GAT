...
def init_args():
    ...
    # parser.add_argument('--file-dir', type=str, default="/root/TR-pptusn/DeepInf-master/dataset/data/digg", help="Input file directory")
    # parser.add_argument('--file-dir', type=str, default="/root/TR-pptusn/DeepInf-preprocess/preprocess/stages_op_inf_100_1k5", help="Input file directory")
    parser.add_argument('--file-dir', type=str, required=True, help="Input file directory")
    ...
    logger.info(f"Args: epochs={args.epochs}, file_dir={args.file_dir}, lr={args.lr}, weight_decay={args.weight_decay}, hidden_units={args.hidden_units}, heads={args.heads}, batch_size={args.batch}, check_point={args.check_point}, gpu={args.gpu}, train_ratio={args.train_ratio}, valid_ratio={args.valid_ratio}, class_weight_balanced={args.class_weight_balanced}, use_pretrained_emb={args.use_pretrained_emb}")
