...
from src.utils import extend_wholegraph, load_pickle, save_pickle, DATA_ROOTPATH, Ntimestage
...
adj_list, fea_list, y_train, y_val, y_test, train_mask, val_mask, test_mask, my_data = load_data_dblp(os.path.join(DATA_ROOTPATH, "HeterNet/ACM/ACM3025.mat"))
