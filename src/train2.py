...
from model import BatchGAT, HeterGraphAttentionNetwork, BatchGAT2
import numpy as np
import time
import torch
...
def digg_load_dataset(args, train_ratio=60, valid_ratio=20, batch_size=256):
    # data_dirpath = "/root/TR-pptusn/DeepInf-master/dataset/data/digg"
    # data_dirpath = "/root/TR-pptusn/DeepInf-preprocess/preprocess/stages_op_inf_100_1k5"
    # data_dirpath = "/root/TR-pptusn/DeepInf-preprocess/preprocess/stages_lab_inf_199_898012_deg_18_9265_ego_50_neg_1_restart_20"
    # data_dirpath = "/root/TR-pptusn/DeepInf-preprocess/preprocess/stages_lab_inf_40_172140_deg_18_483_ego_50_neg_1_restart_20"

    # data_dirpath = "/root/TR-pptusn/DeepInf-preprocess/preprocess/stages_lab_inf_40_172140_deg_18_483_ego_50_neg_1_restart_20"
    # data_dirpath = "/root/TR-pptusn/DeepInf-preprocess/preprocess/stages_lab_inf_40_172140_deg_18_1144_ego_50_neg_1_restart_20"
    # data_dirpath = "/root/TR-pptusn/DeepInf-preprocess/preprocess/stages_lab_inf_40_172140_deg_18_1476_ego_50_neg_1_restart_20"
    # data_dirpath = "/root/TR-pptusn/DeepInf-preprocess/preprocess/stages_lab_inf_40_172140_deg_18_1907_ego_50_neg_1_restart_20"
    # data_dirpath = "/root/TR-pptusn/DeepInf-preprocess/preprocess/stages_lab_inf_40_172140_deg_18_5676_ego_50_neg_1_restart_20"
    # data_dirpath = "/root/TR-pptusn/DeepInf-preprocess/preprocess/stages_lab_inf_40_172140_deg_18_9265_ego_50_neg_1_restart_20"
    ...
    # logger.info(f"Type: {samples.influence_features.dtype}")
    ...
    # feature_dim = samples.influence_features.shape[2]
